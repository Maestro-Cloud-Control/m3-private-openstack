...
public interface IStaticIpService {

    void save(StaticIpAddress staticIpAddress);

    void update(StaticIpAddress staticIpAddress);

    void delete(StaticIpAddress staticIpAddress);

    StaticIpAddress findById(String id);

    List<StaticIpAddress> findStaticIpAddresses(String zoneId, String projectId, List<String> ipAddresses);
