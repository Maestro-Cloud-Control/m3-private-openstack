...
public interface IOpenStackActivateTenantService {

    Networking setupNetworking(OpenStackTenant tenant, OpenStackRegionConfig region);

    Networking setupTenantLimitedNetworking(TenantNetworkCreationInputParameters inputParameters,
