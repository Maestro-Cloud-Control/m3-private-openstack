...
@Component("osRemoveVolumeHandler")
public class OsRemoveVolumeHandler extends AbstractVolumeHandler implements IM3ApiHandler {

    @Autowired
    public OsRemoveVolumeHandler(IOpenStackRegionRepository regionDbService, TenantDbService tenantDbService,
    ...
    public M3RawResult handle(M3ApiAction action) throws M3PrivateAgentException {
        ...
        try {
            ...
            removeVolume(region, tenant, volume);
    ...
    private void removeVolume(OpenStackRegionConfig region,
    ...
    public Set<ActionType> getSupportedActions() {
        return new HashSet<>(Collections.singletonList(ActionType.REMOVE_VOLUME));
    }
}
