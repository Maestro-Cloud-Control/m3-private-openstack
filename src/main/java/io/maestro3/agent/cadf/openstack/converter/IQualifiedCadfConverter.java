...
import io.maestro3.cadf.converter.ICadfConverter;

import java.util.List;

public interface IQualifiedCadfConverter extends ICadfConverter<Notification> {

    List<EventType> getSupportedEventTypes();

    List<AuditEventGroupType> getOutputEventGroups();
}
