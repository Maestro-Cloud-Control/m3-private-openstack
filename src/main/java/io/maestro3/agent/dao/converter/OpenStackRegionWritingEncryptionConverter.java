...
@Component
@WritingConverter
public class OpenStackRegionWritingEncryptionConverter extends AbstractMongoConverter<OpenStackRegionConfig, Document>{
    @Override
    public Document convert(OpenStackRegionConfig openStackRegionConfig) {
