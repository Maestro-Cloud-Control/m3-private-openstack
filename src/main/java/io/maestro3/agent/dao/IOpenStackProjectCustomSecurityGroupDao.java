...
public interface IOpenStackProjectCustomSecurityGroupDao extends ICustomSecurityConfigDao<OpenStackProjectCustomSecurityGroup> {
    ...
    Collection<OpenStackProjectCustomSecurityGroup> findForInstance(String projectId, String instanceId);

    void remove(String projectId, String instanceId);
