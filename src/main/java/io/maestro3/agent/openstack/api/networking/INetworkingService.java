...
public interface INetworkingService {
    ...
    ISubnetService subnets();

    IRouterExtension routers();

    IFloatingIpExtension floatingIps();

    ISecurityGroupExtension securityGroups();

    ISecurityGroupRuleExtension securityGroupRules();

    IPortExtension ports();
