...
public class VolumesExtension extends BasicService implements IVolumesExtension {

    private static final IOSClientOption WITH_NULL_SERIALIZER = OSClientOption.builder().withNullSerializer().build();
    public VolumesExtension(IOSClient client) {
    ...
    @Override
    public List<CinderVolume> list(String nativeId) throws OSClientException {
