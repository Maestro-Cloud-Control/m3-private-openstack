...
public interface IQuotasExtension {
    ...
    NetworkingQuota get(String projectId) throws OSClientException;

    NetworkingQuota update(String projectId, UpdateNetworkingQuotaRequest request) throws OSClientException;
}
