...
public class RemoveRouterInterface {
    ...
    public static class Builder {
        ...
        private RemoveRouterInterface configuration = new RemoveRouterInterface();
        ...
        public RemoveRouterInterface get() {
