...
public interface IQuotasExtension {
    ...
    IComputeQuota getDetailed(String projectId) throws OSClientException;

    IComputeQuota get(String projectId) throws OSClientException;

    IComputeQuota update(String projectId, UpdateComputeQuotaRequest request) throws OSClientException;
}
