...
public interface IKeyPairExtension {

    KeyPair importKeyPair(String name, String publicKey) throws OSClientException;

    List<NovaKeyPair> list() throws OSClientException;

    void deleteKeyPair(String name) throws OSClientException;

    KeyPair inspect(String name) throws OSClientException;
}
