...
public interface IComputeService {
    ...
    IFlavorService flavors();

    IComputeImageService images();

    IServerService servers();

    IKeyPairExtension keyPairs();

    IMetadataExtension metadata();

    IPortInterfaceExtension portInterfaces();

    IQuotasExtension quotas();

    IHostAggregatesExtension hostAggregates();

    IHypervisorsExtension hypervisors();

    IAvailabilityZonesExtension availabilityZones();
}
