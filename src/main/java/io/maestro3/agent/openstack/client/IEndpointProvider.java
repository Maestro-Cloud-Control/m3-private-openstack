...
interface IEndpointProvider {
     ...
     * @return endpoint url
     */
    URL getNullableEndpoint(ServiceType type) throws OSClientException;

    URL getNullableEndpoint(ServiceType type, EndpointExtractor endpointExtractor) throws OSClientException;

    URL getDefaultEndpoint();
}
